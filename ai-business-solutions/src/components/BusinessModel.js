  ...
  const features = [
    {
      ...
      description: "Generate comprehensive business models with AI-driven insights.",
      icon: Briefcase
    },
    {
      title: "Future-Focused Strategies",
      description: "Explore AI-generated innovative strategies tailored to your industry and target year.",
      icon: TrendingUp
    },
    {
      title: "Predictive Analytics",
      description: "Leverage AI-powered predictive analytics to forecast business trends and make data-driven decisions.",
      icon: BarChart2
    },
    {
      title: "Detailed Reports",
      description: "Receive detailed reports on your innovative business model, including potential challenges and KPIs.",
      icon: FileText
    },
  ];
        ...
        <AnimatePresence>
          ...
          {loading && (
            <motion.div 
              ...
              transition={{ duration: 0.5 }}
            >
              <p style={{ marginTop: '1.5rem', color: '#D1D5DB' }}>Generating innovative business model...</p>
            </motion.div>
          )}
          ...
          {generatedData && (
            ...
            >
              <Section title="Business Model" data={generatedData.business_model} />
              <Section title="AI Enhancements" data={generatedData.ai_enhancements} />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
